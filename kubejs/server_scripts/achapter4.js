onEvent('recipes', event => {
    event.shaped('kubejs:pellet_wand', [           
        ' W ',
        ' S ',
        ' S '
],{
...
event.recipes.createSequencedAssembly([
   ...
   [
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', 'minecraft:black_dye']),
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', 'kubejs:mix_block']),
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', 'mekanism:steel_casing']),
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', 'kubejs:printed_rs']),
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', 'kubejs:printed_mek']),
    event.recipes.createDeploying('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', '#forge:pw']),
    event.recipes.createFilling('kubejs:middle_blackiron_ingot', ['kubejs:middle_blackiron_ingot', Fluid.of('minecraft:water',1000)])
]).transitionalItem('kubejs:middle_blackiron_ingot').loops(1)

event.remove({output:'extendedcrafting:black_iron_ingot'})

event.custom({"type":"mekanism:painting","itemInput":{"ingredient":{"type":"forge:difference","base":{"item":"kubejs:wblackiron_ingot"},"subtracted":{"item":"extendedcrafting:black_iron_ingot"}}},"chemicalInput":{"amount":32,"pigment":"mekanism:black"},"output":{"item":"extendedcrafting:black_iron_ingot"}})
...
event.recipes.createSequencedAssembly([
   ...
   'create:golden_sheet', 
   [
    event.recipes.createDeploying('create:incomplete_precision_mechanism', ['create:incomplete_precision_mechanism', 'minecraft:gold_ingot']),
    event.recipes.createDeploying('create:incomplete_precision_mechanism', ['create:incomplete_precision_mechanism', 'minecraft:gold_ingot']),
    event.recipes.createDeploying('create:incomplete_precision_mechanism', ['create:incomplete_precision_mechanism', 'minecraft:gold_ingot'])
...
event.shaped('kubejs:rainbow_rod', [           
    ' W ',
    ' S ',
    ' W '
],{
